...
### 5. RAG Integration (`rag_client.py`) ✅ [COMPLETED] ⚠️ **CRITICAL**
**Supabase Edge Function ONLY** ❌ No FAISS/local RAG
- [x] Create HTTP client using `httpx`
- [x] Create function: `fetch_rag_context(query: str, lang: str) -> str`
- [x] Headers: `Authorization: Bearer SUPABASE_KEY`
- [x] Endpoint: `SUPABASE_RAG_URL`
- [x] POST request:
  ```json
  {
    "query": "user query",
